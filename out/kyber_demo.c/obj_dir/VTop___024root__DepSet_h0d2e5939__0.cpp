...
VL_INLINE_OPT void VTop___024root___nba_sequent__TOP__0(VTop___024root* vlSelf) {
    ...
    vlSelfRef.Top__DOT__core__DOT__mem_reg_ins = ((IData)(vlSelfRef.reset)
                                                   ? 0U
...
#endif
            VL_FATAL_MT("/home/mhussain/XSoC-Lite/nucleusrv/../out/kyber_demo.c/Top.v", 7021, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("/home/mhussain/XSoC-Lite/nucleusrv/../out/kyber_demo.c/Top.v", 7021, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("/home/mhussain/XSoC-Lite/nucleusrv/../out/kyber_demo.c/Top.v", 7021, "", "Active region did not converge.");
            }
...
void VTop___024root___eval_debug_assertions(VTop___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.io_baby_kyber_req_ready 
                      & 0xfeU)))) {
        Verilated::overWidthError("io_baby_kyber_req_ready");}
    if (VL_UNLIKELY(((vlSelfRef.io_baby_kyber_rsp_valid 
                      & 0xfeU)))) {
        Verilated::overWidthError("io_baby_kyber_rsp_valid");}
    if (VL_UNLIKELY(((vlSelfRef.io_baby_kyber_rsp_bits_error 
                      & 0xfeU)))) {
        Verilated::overWidthError("io_baby_kyber_rsp_bits_error");}
    if (VL_UNLIKELY(((vlSelfRef.io_baby_kyber_cio_babykyber_intr_key 
                      & 0xfeU)))) {
        Verilated::overWidthError("io_baby_kyber_cio_babykyber_intr_key");}
    if (VL_UNLIKELY(((vlSelfRef.io_baby_kyber_cio_babykyber_intr_encrypt 
                      & 0xfeU)))) {
        Verilated::overWidthError("io_baby_kyber_cio_babykyber_intr_encrypt");}
    if (VL_UNLIKELY(((vlSelfRef.io_baby_kyber_cio_babykyber_intr_decrypt 
                      & 0xfeU)))) {
        Verilated::overWidthError("io_baby_kyber_cio_babykyber_intr_decrypt");}
    if (VL_UNLIKELY(((vlSelfRef.io_uart_req_ready & 0xfeU)))) {
        Verilated::overWidthError("io_uart_req_ready");}
    if (VL_UNLIKELY(((vlSelfRef.io_uart_rsp_valid & 0xfeU)))) {
        Verilated::overWidthError("io_uart_rsp_valid");}
    if (VL_UNLIKELY(((vlSelfRef.io_uart_rsp_bits_error 
                      & 0xfeU)))) {
        Verilated::overWidthError("io_uart_rsp_bits_error");}
    if (VL_UNLIKELY(((vlSelfRef.io_uart_cio_uart_rx_i 
                      & 0xfeU)))) {
        Verilated::overWidthError("io_uart_cio_uart_rx_i");}
}
#endif  // VL_DEBUG
